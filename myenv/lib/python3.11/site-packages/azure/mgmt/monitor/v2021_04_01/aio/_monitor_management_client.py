...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype data_collection_endpoints:
     azure.mgmt.monitor.v2021_04_01.aio.operations.DataCollectionEndpointsOperations
    ...
    :vartype data_collection_rule_associations:
     azure.mgmt.monitor.v2021_04_01.aio.operations.DataCollectionRuleAssociationsOperations
    :ivar data_collection_rules: DataCollectionRulesOperations operations
    :vartype data_collection_rules:
     azure.mgmt.monitor.v2021_04_01.aio.operations.DataCollectionRulesOperations
