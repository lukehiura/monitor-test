...
# --------------------------------------------------------------------------
import urllib.parse
from typing import (IO, Any, AsyncIterable, Callable, Dict, Optional, TypeVar,
                    Union, cast, overload)
...
from ...operations._action_groups_operations import (
    ...
    build_create_or_update_request, build_delete_request,
    build_enable_receiver_request, build_get_request,
    ...
    build_get_test_notifications_request, build_list_by_resource_group_request,
    build_list_by_subscription_id_request,
    build_post_test_notifications_request, build_update_request)
...
class ActionGroupsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type action_group: ~azure.mgmt.monitor.v2022_06_01.models.ActionGroupResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActionGroupResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2022_06_01.models.ActionGroupResource
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type action_group: ~azure.mgmt.monitor.v2022_06_01.models.ActionGroupResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type action_group_patch: ~azure.mgmt.monitor.v2022_06_01.models.ActionGroupPatchBody
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type action_group_patch: ~azure.mgmt.monitor.v2022_06_01.models.ActionGroupPatchBody or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_post_test_notifications(
        ...
        **kwargs: Any
        ...
        :param notification_request: The notification request body which includes the contact details.
         Required.
        :type notification_request: ~azure.mgmt.monitor.v2022_06_01.models.NotificationRequestBody
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.monitor.v2022_06_01.models.TestNotificationDetailsResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_post_test_notifications(
        ...
        :type notification_request: ~azure.mgmt.monitor.v2022_06_01.models.NotificationRequestBody or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
    ...
    async def get_test_notifications(
        ...
        :rtype: ~azure.mgmt.monitor.v2022_06_01.models.TestNotificationDetailsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    def list_by_subscription_id(self, **kwargs: Any) -> AsyncIterable["_models.ActionGroupResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2022_06_01.models.ActionGroupResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def enable_receiver(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type enable_request: ~azure.mgmt.monitor.v2022_06_01.models.EnableRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def enable_receiver(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param enable_request: The receiver to re-enable. Is either a EnableRequest type or a IO type.
         Required.
        :type enable_request: ~azure.mgmt.monitor.v2022_06_01.models.EnableRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
