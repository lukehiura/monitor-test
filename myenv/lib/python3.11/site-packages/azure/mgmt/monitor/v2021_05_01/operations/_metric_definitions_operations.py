...
class MetricDefinitionsOperations:
    ...
    def list_at_subscription_scope(
    ...
    ) -> Iterable["_models.SubscriptionScopeMetricDefinition"]:
        ...
        :return: An iterator like instance of either SubscriptionScopeMetricDefinition or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.v2021_05_01.models.SubscriptionScopeMetricDefinition]
    ...
    def list(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.v2021_05_01.models.MetricDefinition]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
