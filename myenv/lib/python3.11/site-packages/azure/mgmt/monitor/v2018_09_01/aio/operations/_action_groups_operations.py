...
class ActionGroupsOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type action_group: ~azure.mgmt.monitor.v2018_09_01.models.ActionGroupResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type action_group_patch: ~azure.mgmt.monitor.v2018_09_01.models.ActionGroupPatchBody
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type action_group_patch: ~azure.mgmt.monitor.v2018_09_01.models.ActionGroupPatchBody or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription_id(self, **kwargs: Any) -> AsyncIterable["_models.ActionGroupResource"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2018_09_01.models.ActionGroupResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def enable_receiver(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type enable_request: ~azure.mgmt.monitor.v2018_09_01.models.EnableRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def enable_receiver(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param enable_request: The receiver to re-enable. Is either a EnableRequest type or a IO type.
         Required.
        :type enable_request: ~azure.mgmt.monitor.v2018_09_01.models.EnableRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
