...
from ...operations._data_collection_rules_operations import (
    build_create_request, build_delete_request, build_get_request,
    build_list_by_resource_group_request, build_list_by_subscription_request,
...
class DataCollectionRulesOperations:
    ...
    def list_by_resource_group(
        ...
        :return: An iterator like instance of either DataCollectionRuleResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2019_11_01_preview.models.DataCollectionRuleResource]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.monitor.v2019_11_01_preview.models.DataCollectionRuleResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.monitor.v2019_11_01_preview.models.DataCollectionRuleResource
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a DataCollectionRuleResource type or a IO type. Default
         value is None.
        :type body: ~azure.mgmt.monitor.v2019_11_01_preview.models.DataCollectionRuleResource or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type data_collection_rule_name: str
        :param body: The payload. Default value is None.
        :type body: ~azure.mgmt.monitor.v2019_11_01_preview.models.ResourceForUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :param body: The payload. Is either a ResourceForUpdate type or a IO type. Default value is
         None.
        :type body: ~azure.mgmt.monitor.v2019_11_01_preview.models.ResourceForUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
