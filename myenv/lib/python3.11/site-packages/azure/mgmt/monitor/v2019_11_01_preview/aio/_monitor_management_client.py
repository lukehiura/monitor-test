...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype data_collection_rule_associations:
     azure.mgmt.monitor.v2019_11_01_preview.aio.operations.DataCollectionRuleAssociationsOperations
    :ivar data_collection_rules: DataCollectionRulesOperations operations
    :vartype data_collection_rules:
     azure.mgmt.monitor.v2019_11_01_preview.aio.operations.DataCollectionRulesOperations
