...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype metric_definitions:
     azure.mgmt.monitor.v2018_01_01.aio.operations.MetricDefinitionsOperations
    :ivar metrics: MetricsOperations operations
    :vartype metrics: azure.mgmt.monitor.v2018_01_01.aio.operations.MetricsOperations
