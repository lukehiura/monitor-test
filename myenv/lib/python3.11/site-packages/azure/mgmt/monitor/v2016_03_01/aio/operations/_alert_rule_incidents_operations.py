...
from ...operations._alert_rule_incidents_operations import (
    build_get_request, build_list_by_alert_rule_request)
...
class AlertRuleIncidentsOperations:
    ...
    async def get(
        self, resource_group_name: str, rule_name: str, incident_name: str, **kwargs: Any
    ) -> _models.Incident:
    ...
    def list_by_alert_rule(
    ...
    ) -> AsyncIterable["_models.Incident"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2016_03_01.models.Incident]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
