...
class MetricDefinitionsOperations:
    ...
    @distributed_trace
    def list(self, resource_uri: str, **kwargs: Any) -> Iterable["_models.MetricDefinition"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.monitor.v2017_05_01_preview.models.MetricDefinition]
