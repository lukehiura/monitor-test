...
def build_get_onboarding_status_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{resourceUri}/providers/Microsoft.Insights/vmInsightsOnboardingStatuses/default"
    )
...
class VMInsightsOperations:
    ...
    @distributed_trace
    def get_onboarding_status(self, resource_uri: str, **kwargs: Any) -> _models.VMInsightsOnboardingStatus:
