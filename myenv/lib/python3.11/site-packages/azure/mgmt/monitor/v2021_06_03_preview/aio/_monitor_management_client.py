...
from .operations import (AzureMonitorWorkspacesOperations,
...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype azure_monitor_workspaces:
     azure.mgmt.monitor.v2021_06_03_preview.aio.operations.AzureMonitorWorkspacesOperations
    :ivar monitor_operations: MonitorOperationsOperations operations
    :vartype monitor_operations:
     azure.mgmt.monitor.v2021_06_03_preview.aio.operations.MonitorOperationsOperations
