...
from .operations import ActionGroupsOperations, ActivityLogAlertsOperations
...
class MonitorManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype action_groups: azure.mgmt.monitor.v2017_04_01.aio.operations.ActionGroupsOperations
    :ivar activity_log_alerts: ActivityLogAlertsOperations operations
    :vartype activity_log_alerts:
     azure.mgmt.monitor.v2017_04_01.aio.operations.ActivityLogAlertsOperations
