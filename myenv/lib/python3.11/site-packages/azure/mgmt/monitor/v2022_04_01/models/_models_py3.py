...
class ActionGroupList(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.monitor.v2022_04_01.models.ActionGroupResource]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~azure.mgmt.monitor.v2022_04_01.models.ActionGroupResource]
...
class ActionGroupResource(AzureResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype email_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.EmailReceiver]
    :ivar sms_receivers: The list of SMS receivers that are part of this action group.
    :vartype sms_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.SmsReceiver]
    :ivar webhook_receivers: The list of webhook receivers that are part of this action group.
    :vartype webhook_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.WebhookReceiver]
    :ivar itsm_receivers: The list of ITSM receivers that are part of this action group.
    :vartype itsm_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.ItsmReceiver]
    ...
    :vartype azure_app_push_receivers:
     list[~azure.mgmt.monitor.v2022_04_01.models.AzureAppPushReceiver]
    ...
    :vartype automation_runbook_receivers:
     list[~azure.mgmt.monitor.v2022_04_01.models.AutomationRunbookReceiver]
    ...
    :vartype logic_app_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.LogicAppReceiver]
    :ivar azure_function_receivers: The list of azure function receivers that are part of this
     action group.
    :vartype azure_function_receivers:
     list[~azure.mgmt.monitor.v2022_04_01.models.AzureFunctionReceiver]
    ...
    :vartype event_hub_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.EventHubReceiver]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype email_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.EmailReceiver]
        :keyword sms_receivers: The list of SMS receivers that are part of this action group.
        :paramtype sms_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.SmsReceiver]
        :keyword webhook_receivers: The list of webhook receivers that are part of this action group.
        :paramtype webhook_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.WebhookReceiver]
        :keyword itsm_receivers: The list of ITSM receivers that are part of this action group.
        :paramtype itsm_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.ItsmReceiver]
        ...
        :keyword logic_app_receivers: The list of logic app receivers that are part of this action
         group.
        :paramtype logic_app_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.LogicAppReceiver]
        ...
        :keyword event_hub_receivers: The list of event hub receivers that are part of this action
         group.
        :paramtype event_hub_receivers: list[~azure.mgmt.monitor.v2022_04_01.models.EventHubReceiver]
        """
...
class EmailReceiver(_serialization.Model):
    ...
    :ivar status: The receiver status of the e-mail. Known values are: "NotSpecified", "Enabled",
     and "Disabled".
    :vartype status: str or ~azure.mgmt.monitor.v2022_04_01.models.ReceiverStatus
    """
...
class TestNotificationDetailsResponse(_serialization.Model):
    ...
    :vartype context: ~azure.mgmt.monitor.v2022_04_01.models.Context
    ...
    :vartype action_details: list[~azure.mgmt.monitor.v2022_04_01.models.ActionDetail]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype context: ~azure.mgmt.monitor.v2022_04_01.models.Context
        ...
        :paramtype action_details: list[~azure.mgmt.monitor.v2022_04_01.models.ActionDetail]
        """
        super().__init__(**kwargs)
