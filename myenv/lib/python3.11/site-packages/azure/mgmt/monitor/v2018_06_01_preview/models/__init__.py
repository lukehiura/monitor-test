...
from ._models_py3 import (DataSource, DataSourceConfiguration, ErrorResponse,
                          EtwEventConfiguration, EtwProviderConfiguration,
                          ...
                          PerformanceCounterConfiguration, Resource,
                          SinkConfiguration)
