...
from ...operations._private_link_scopes_operations import (
    ...
    build_list_by_resource_group_request, build_list_request,
...
class PrivateLinkScopesOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.AzureMonitorPrivateLinkScope"]:
        ...
        :return: An iterator like instance of either AzureMonitorPrivateLinkScope or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.monitor.v2021_07_01_preview.models.AzureMonitorPrivateLinkScope]
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.monitor.v2021_07_01_preview.models.AzureMonitorPrivateLinkScope
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type azure_monitor_private_link_scope_payload:
         ~azure.mgmt.monitor.v2021_07_01_preview.models.AzureMonitorPrivateLinkScope
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param azure_monitor_private_link_scope_payload: Properties that need to be specified to create
         ...
         IO type. Required.
        :type azure_monitor_private_link_scope_payload:
         ~azure.mgmt.monitor.v2021_07_01_preview.models.AzureMonitorPrivateLinkScope or IO
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :param private_link_scope_tags: Updated tag information to set into the PrivateLinkScope
         instance. Required.
        :type private_link_scope_tags: ~azure.mgmt.monitor.v2021_07_01_preview.models.TagsResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update_tags(
        ...
        **kwargs: Any
        ...
        :type private_link_scope_tags: ~azure.mgmt.monitor.v2021_07_01_preview.models.TagsResource or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
